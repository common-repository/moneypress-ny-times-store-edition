...
if (class_exists('wpCSL_plugin', false) === false) {
    require_once(MP_NYTSTORE_PLUGINDIR.'WPCSL-generic/CSL-plugin.php');
}
...
$MP_nytstore_plugin = new wpCSL_plugin(
    array(
        ...
        'prefix'                 => 'csl-mp-nytstore',
        'name'                   => 'MoneyPress : NY Times Store Edition',
        'url'                    => 'http://www.cybersprocket.com/products/moneypress-buyat-edition/',
        'paypal_button_id'       => '5XQ3BECSAXB82',
        'plugin_path'            => MP_NYTSTORE_PLUGINDIR,
        'plugin_url'             => MP_NYTSTORE_PLUGINURL,
        'cache_path'             => MP_NYTSTORE_PLUGINDIR . 'cache',
        'driver_name'            => 'Buyat',
        'driver_args'            => array(get_option('csl-mp-nytstore-api_key'),'1208'),
        'shortcodes'             => array('mp-nytstore','mp_nytstore'),
        'wp_filter_id'           => '6'
    )
);
...
$MP_nytstore_plugin->settings->add_section(
    array(
        'name' => 'How to Use',
        'description' =>
        '<p>To use MoneyPress : NY Times Store Edition you only need to add a simple '                   .
        'shortcode to any page where you want to show NY Times Store products.  An example '              .
        'of the shortcode is <code>[mp-nytstore keywords="jewelry"]</code>. '     .
        'Putting this code on a page would show ten products from NY Times Store' .
        ...
        'or you can change it in the shortcode itself, e.g. <code>[mp-nytstore '            .

...
Tags: plugin,post,page,affiliate,store,products,ecommerce,revenue sharing,storefront,buyat,nytimes,ny times,ny time store
Requires at least: 2.6
Tested up to: 3.0
Stable tag: 1.02

MoneyPress : NY Times Store Edition allows you to quickly and easily display products from NY Times Store on any page or post via a simple shortcode. 

== Description ==

MoneyPress : NY Times Store Edition allows you to quickly and easily display products from NY Times Store on any page or post via a simple shortcode.  Install the plugin and you can add products to your existing blog posts or pages just be entering a shortcode. Multiple configuration options allow you to customize the display.  If you are a NY Times Store reseller, this plugin is for you!
...
* <a href="http://redmine.cybersprocket.com/projects/moneypress-nytstore/wiki" title="MoneyPress : NY Times Store Edition Knowledgebase">MoneyPress : NY Times Store Edition Knowledgebase</a>
* <a href="http://redmine.cybersprocket.com/projects/moneypress-nytstore/boards" title="MoneyPress : NY Times Store Edition Forums">MoneyPress : NY Times Store Edition Forums</a> 
...
* Get your API key from the NY Times Store developer site.
* Install the plugin using the zip file.
* Go to MoneyPress : NY Times Store in the Wordpress Settings menu.
* Enter your NY Times Store Developer API key.
...
1. Demo page showing results of a simple shortcode entry.
2. Demo page with multiple products shown from single shortcode.
3. The MoneyPress : NY Times Store settings page.
...
To learn more, visit our <a href="http://redmine.cybersprocket.com/projects/moneypress-nytstore/wiki" title="MoneyPress : NY Times Store Edition Knowledgebase">knowledgebase</a> or visit our <a href="http://redmine.cybersprocket.com/projects/moneypress-nytstore/boards">Community Forums</a>.
